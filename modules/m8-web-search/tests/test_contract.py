"""
B3.2 Schemathesis contract lock — M8-web-search.

Validates that packages/contracts/m8-web-search.openapi.yaml is internally consistent.
No live server required: static spec validation only.

Run:
  pytest modules/m8-web-search/tests/test_contract.py -v
"""
...
SPEC_PATH = CONTRACTS_DIR / "m8-web-search.openapi.yaml"
...
class TestM8WebSearchContract:
    ...
    def test_spec_loads_without_error(self):
        ...
        assert len(ops) > 0, "No operations found in m8-web-search contract spec"
