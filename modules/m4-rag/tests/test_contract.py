"""
B3.2 Schemathesis contract lock — M4-rag.

Validates that packages/contracts/m4-rag.openapi.yaml is internally consistent.
No live server required: static spec validation only.

Run:
  pytest modules/m4-rag/tests/test_contract.py -v
"""
...
SPEC_PATH = CONTRACTS_DIR / "m4-rag.openapi.yaml"
...
class TestM4RagContract:
    ...
    def test_spec_loads_without_error(self):
        ...
        assert len(ops) > 0, "No operations found in m4-rag contract spec"
