"""
B3.2 Schemathesis contract lock — M5-gateway.

Validates that packages/contracts/m5-gateway.openapi.yaml is internally consistent.
No live server required: static spec validation only.

Run:
  pytest modules/m5-gateway/tests/test_contract.py -v
"""
...
SPEC_PATH = CONTRACTS_DIR / "m5-gateway.openapi.yaml"
...
class TestM5GatewayContract:
    ...
    def test_spec_loads_without_error(self):
        ...
        assert len(ops) > 0, "No operations found in m5-gateway contract spec"
