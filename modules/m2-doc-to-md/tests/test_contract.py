"""
B3.2 Schemathesis contract lock — M2 Doc-to-MD (Ingest).

Validates that packages/contracts/m2-ingest.openapi.yaml is internally consistent.
No live server required: static spec validation only.

Run:
  pytest modules/m2-doc-to-md/tests/test_contract.py -v
"""
...
SPEC_PATH = CONTRACTS_DIR / "m2-ingest.openapi.yaml"
...
class TestM2IngestContract:
    ...
    def test_spec_loads_without_error(self):
        ...
        assert len(ops) > 0, "No operations found in m2-ingest contract spec"
